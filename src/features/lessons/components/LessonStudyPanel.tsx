  ...
  return (
    <section className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-4 shadow-sm shadow-black/5">
      <div className="border-b border-[var(--border)] pb-4">
        ...
        <h2 className="mt-2 text-lg font-semibold text-[var(--text)]">Status da aula</h2>
      </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        ...
        <PanelCell icon={<Trophy className="h-4 w-4" />} label="Exercicios" value={exercisesCount} />
      </div>
      ...
      <div className="mt-3 rounded-lg border border-[var(--border)] bg-[var(--surface-soft)] p-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-[var(--text)]">{isCompleted ? 'Aula concluida' : 'Em andamento'}</p>
        </div>
      ...
      >
        ...
        {isCompleted ? 'Aula concluida' : isCompleting ? 'Salvando...' : 'Marcar como concluida'}
      </button>
    </section>
  );
}
